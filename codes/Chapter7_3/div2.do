...
add wave -noupdate /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id_ex0/id_aluop
add wave -noupdate /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id_ex0/id_reg1
add wave -noupdate /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id_ex0/id_reg2
...
WaveRestoreCursors {{Cursor 1} {290100 ps} 1} {{Cursor 2} {710344 ps} 1} {{Cursor 3} {690085 ps} 1} {{Cursor 4} {290000 ps} 0}
...
update
WaveRestoreZoom {116552 ps} {743928 ps}
